...
public:
    ...
    MYSQL* mysql;
    int m_state;    // 0 means read, and 1 means write
    ...
    enum CHECK_STATE {
        CHECK_STATE_REQUESTLINE = 0, CHECK_STATE_HEADER, CHEACK_CONTENT
    };
    enum HTTP_CODE {
        NO_REQUEST, GET_QUEST, BAD_REQUEST, NO_RESOURCE, FORBIDDEN_REQUEST, FILE_REQUEST, INTERNAL_ERROR, CLOSED_CONNECTION
    };
    enum LINE_STATUS {
